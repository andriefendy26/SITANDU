...
<style>
    ...
    .layanan-doc-link svg { width: 12px; height: 12px; stroke: currentColor; }
...
<div class="page-hero">
    ...
    <p>Layanan terkait seputaran kegiatan posyandu, jadwal dan informasi lainnya.</p>
</div>
                ...
                <div class="layanan-grid">
                    ...
                    <a href="{{ route('layanan.show', $layanan->id) }}" class="layanan-card">
                        ...
                        @if($layanan->documents->count() > 0)
                            @foreach($layanan->documents->take(2) as $doc)
                            <a href="{{ asset('storage/' . $doc->file_path) }}" target="_blank" class="layanan-doc-link">
                            ...
                            @endforeach
                            @if($layanan->documents->count() > 2)
                            <span style="font-size:11px;color:var(--text-muted);">+{{ $layanan->documents->count() - 2 }} lainnya</span>
                            @endif
                        @endif
