...
<div class="filter-bar">
    <div class="filter-bar-inner">
        ...
        <div class="filter-pills">
            <a href="{{ route('kegiatan.index') }}" class="filter-pill {{ !request('kategori') ? 'active' : '' }}">Semua</a>
            @foreach($kategoris as $kategori)
                <a href="{{ route('kegiatan.index', ['kategori' => $kategori->id]) }}"
